...
public interface PhotoService {
    ...
    PhotoDto savePhoto(PhotoDescriptionDto descriptionDto, ImageData data, long userId);

    PhotoDto getPhotoById(long photoId, long userId);

    List<PhotoDto> getAllByAlbumId(long albumId, long userId);

    PhotoDto updateDescription(PhotoDescriptionDto description, long photoId, long userId);
